        ...
        <?php
            ...
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="../img/<?=$reg["imagen_producto"]?>" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?=$reg['nombreproducto']?></h1>
                            <p class="h3 py-2">$<?=$reg['costoventa']?></p>
                            <p class="py-2">
